...
class CreateSkynettechnologiesAllinoneaccessibilityAllinoneaccessibilitysTable extends Migration
{
    /*
     * Run the migrations.
     *
    ...
    public function up()
    {
         ...
         */
        Schema::create('skynettechnologies_allinoneaccessibility_allinoneaccessibilitys', function ($table) {
            $table->increments('id');
    ...
    */
    ...
    {
        Schema::drop('skynettechnologies_allinoneaccessibility_allinoneaccessibilitys');
    }
}
