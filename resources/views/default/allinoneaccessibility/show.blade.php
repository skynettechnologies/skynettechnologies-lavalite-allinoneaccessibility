...
<div class="app-entry-form-wrap">
        ...
        <div class="actions">
            <div class="action-buttons">
                <button type="button" class="btn btn-with-icon btn-link" data-action='EDIT' data-load-to="#app-entry"
                    data-url="{!!guard_url('allinoneaccessibility/allinoneaccessibility')!!}/{!!$data['id']!!}/edit"><i
                ...
                <button type="button" class="btn btn-with-icon btn-link" data-action='DELETE' data-load-to="#app-entry"
                    data-list="#item-list" data-url="{!!guard_url('allinoneaccessibility/allinoneaccessibility')!!}/{!!$data['id']!!}"><i
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-8 entry-form">
            ...
            ->class('app-form-show')
            ->method('PUT')
            ->action(guard_url('allinoneaccessibility/allinoneaccessibility'. $data['id']))!!}
            ...
            @include('allinoneaccessibility::allinoneaccessibility.partials.form')

            {!!Form::close()!!}
        </div>

            @include('allinoneaccessibility::allinoneaccessibility.partials.aside')
        </div>
    </div>
