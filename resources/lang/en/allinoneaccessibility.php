...
return [
    /*
    |--------------------------------------------------------------------------
    | Language files for allinoneaccessibility in allinoneaccessibility package
    |--------------------------------------------------------------------------
    |
    | The following language lines are  for  allinoneaccessibility module in allinoneaccessibility package
    ...
    */
    ...
    'placeholder'   => [
        ...
        'lat'                        => 'Please enter lat',
        'lng'                        => 'Please enter lng',
